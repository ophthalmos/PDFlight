...
public partial class MainForm : Form
{
    ...
    public MainForm(string startFile)
    {
        ...
        viewHost = new PdfViewHost(webView) { TwoPageDefault = settings.TwoPageLayout };
    ...
    private void OpenSettings(int tabIndex)
    {
        ...
        if (dialog.ShowDialog(this) == DialogResult.OK)
        {
            ...
            settings.TwoPageLayout = dialog.TwoPageLayout;
            viewHost.TwoPageDefault = settings.TwoPageLayout;
